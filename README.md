...
Example update default `HOST_NAME` from `d8-boilerplate.test` to `local.mysite.TLD`.

### Starting the containers

`make up`

See Makefile for a list of available targets.

### Add hostname entry in your `/etc/hosts` file
```
127.0.0.1    d8-boilerplate.test
```
NOTE: To use your own domain, make changes in the `.env` file.

With `composer require ...` you can download new dependencies to your 
installation.

@todo: create a makefile command for `composer require`
```
